...
export const operationFeatures = [
  ...
  {
    id: "career-record",
    register: "CAREER RECORD / 04",
    title: "See the pilot the flights created.",
    copy: "Your licence, airline, home base, reputation, flight statistics, ratings and career timeline stay together in one permanent record.",
    visual: "career",
  },
] as const;
